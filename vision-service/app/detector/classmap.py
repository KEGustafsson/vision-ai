...
``detector.model``). Supported models:
  ...
  ``"coco"`` — **COCO** (80 classes, the default); YOLO11n on both the
    torch/tensorrt and DeepStream backends. COCO ids relevant to the marine
    domain: 0=person, 8=boat. Class id 80 is an extension we reserve for "buoy".
